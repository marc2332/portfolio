...
\
Here is the [route](https://clientes.openbank.es/myprofile/accounts/0000000/movements) of the webapp where you can see movements of an account. Make sure to replace the zeros with an account id.
\
