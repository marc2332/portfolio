...
<Head>
    <title>Openbank Useless 2FA when checking the full movements history</title>
</Head>

# Openbank Useless 2FA when checking the full movements history
...
\
This is the route of the webapp where you can see movements of an account: 
**https:\/\/clientes.openbank.es\/myprofile\/accounts\/\<ACCOUNT_ID\>\/movements**
\
...
But here is more to this story, the endpoint used in the script is used in another route of the webapp: **https://clientes.openbank.es/myprofile/global/expenses-by-category/**
\
...
\
In the other hand, the **REST endpoint does not care about maximum dates or extra security requirements**.
\
...
Last message I got was an automated response on December 2nd. They surely can't afford to have a decent technical support.
\
