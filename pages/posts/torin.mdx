...
\
When I started working on Freya I quickly went on to adding new layout features, this lead to the layout logic being too coupled with other core logic of Freya, this eventually got to a point where it was blocking the addition of new features such as incremental layout.
\
